...
const FeedIngredientsItem:FC<{item:IIngredient, orders: IWebsocketOrders[], orderId: string}> = ({item, orders, orderId}) => {
    ...
    return <li
        ...
        <div className={FeedDetailsStyles.ingredientsPriceContainer}>
            <p>{getCountIngredientsInOrder(orders, item._id, orderId)} x {item.price}</p>
...
const FeedDetails: FC<{ orders?: IWebsocketOrders[] }> = ({orders}) => {
    ...
    return <section className={FeedDetailsStyles.container}>
        <div className={FeedDetailsStyles.innerContainer}>
            ...
            <div className={FeedDetailsStyles.footer}>
                <time className={FeedDetailsStyles.time}
                      dateTime={createdAt}>{getTimeFromTimestamp(createdAt ? createdAt : 'nothing')}</time>
