...
const BurgerIngredientsSkeleton: VFC = () => {
    return (
        <div className={styles.container}>
            <Skeleton width={330} height={35} baseColor="#2F2F37" highlightColor="#8585AD" />

            <ul className={styles.list}>
                <li>
                    <Skeleton width={50} height={15} baseColor="#2F2F37" highlightColor="#8585AD" />
                </li>
                <li>
                    <Skeleton width={50} height={15} baseColor="#2F2F37" highlightColor="#8585AD" />
                </li>
            ...
            <div className={styles.goodContainer}>
                <SkeletonTheme baseColor="#2F2F37" highlightColor="#8585AD">
